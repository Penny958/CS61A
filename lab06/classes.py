...
class Player(object):
    ...
    def go_to(self, location):
        ...
        if destination_place.locked:
            ...
            self.name, self.place = location, destination_place
    ...
    def talk_to(self, person):
        ...
        if type(person) != str:
            ...
            if person in list(self.place.characters.keys()):
    ...
    def take(self, thing):
        ...
        elif thing in list(self.place.things.keys()):
            self.backpack.append(self.place.things[thing])
            taken = self.place.take(thing)# self.place.things.pop(thing)
            print('Player takes the ' + taken.name)
        else:
